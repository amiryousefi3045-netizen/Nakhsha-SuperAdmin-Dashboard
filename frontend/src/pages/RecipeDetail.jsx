...
const CATEGORY_FALLBACKS = {
  خورش: "https://images.unsplash.com/photo-1604908176997-431c3a7280e5?w=1200&q=60",
  کباب: "https://images.unsplash.com/photo-1604908554200-4d8f8d9ba4b3?w=1200&q=60",
  سوپ: "https://images.unsplash.com/photo-1617191517009-bb4d9c504761?w=1200&q=60",
  سالاد:
    "https://images.unsplash.com/photo-1568605114967-8130f3a36994?w=1200&q=60",
  دسر: "https://images.unsplash.com/photo-1551024709-8f23befc6cf7?w=1200&q=60",
  برنج: "https://images.unsplash.com/photo-1604908207268-1a2fba9b5d7f?w=1200&q=60",
  نان: "https://images.unsplash.com/photo-1549931319-420c83f9b21d?w=1200&q=60",
  "پیش غذا":
    "https://images.unsplash.com/photo-1544025162-d76694265947?w=1200&q=60",
  نوشیدنی:
    "https://images.unsplash.com/photo-1541976076758-347942db197b?w=1200&q=60",
};
...
const RecipeDetail = () => {
  ...
  const totalMinutes = data.cookingTime?.total;
  ...
  return (
    <div className="max-w-[1100px] mx-auto grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-6 p-4">
      ...
      <section className="bg-white rounded-lg border p-4">
        ...
        <h2 className="text-base font-semibold mt-6">مواد اولیه</h2>
      ...
      <aside className="space-y-4">
        <div className="bg-white rounded-lg border p-4">
          ...
          {user && (user.role === "admin" || user.id === data.author?.id) && (
        ...
        <div className="bg-white rounded-lg border p-4">
          <div className="text-sm text-gray-700">محل ثبت دستور پخت</div>
          <div className="text-sm text-gray-700">محل ثبت اثر / محصول</div>
