...
const ProfileTabs = ({ className = "", onTabChange }) => {
  const [searchParams, setSearchParams] = useSearchParams();

  // Get active tab from URL query params, default to 'posts'
            ...
            return (
              <button
                ...
                className={`
                  ...
                  hover:text-primary-600 focus:outline-none focus:ring-2 focus:ring-primary-500/30 
