...
const SkeletonCard = () => (
  <div className="group block bg-white rounded-2xl overflow-hidden shadow-sm p-0 animate-pulse motion-safe:animate-[pulse_2s_ease-in-out_infinite] motion-reduce:opacity-75">
    {/* Image placeholder */}
    <div className="w-full aspect-[4/3] bg-gradient-to-r from-gray-200 via-gray-300 to-gray-200 rounded-2xl animate-shimmer" />
    ...
    <div className="p-4 space-y-3">
      ...
      {/* Button skeleton */}
      <div className="pt-2">
        <div className="h-9 bg-gray-200 rounded-full w-full animate-pulse" />
      </div>
    </div>
  </div>
);
