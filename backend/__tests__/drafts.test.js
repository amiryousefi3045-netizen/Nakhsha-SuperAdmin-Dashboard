...
describe('Draft Autosave System - Integration Tests', () => {
  beforeAll(async () => {
    ...
    const testDbUri = process.env.TEST_MONGODB_URI || 'mongodb://127.0.0.1:27017/nakhsha-test';
    ...
    // Generate auth token
    authToken = jwt.sign({ id: testUserId, role: 'user' }, process.env.JWT_SECRET || 'test-secret');
