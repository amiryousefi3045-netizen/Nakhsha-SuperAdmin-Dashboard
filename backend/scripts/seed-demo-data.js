...
const demoUsers = [
  { name: "علی رضایی", phone: "09191234567", handle: "demo-ali-rezaei", role: "creator", creatorType: "tour_leader", isVerified: true, isBlocked: false, bio: "تورلیدر اصفهان و کویر مرنجاب", permissions: [], location: { city: "اصفهان" } },
  { name: "مریم احمدی", phone: "09351234568", handle: "demo-maryam-ahmadi", role: "creator", creatorType: "tour_leader", isVerified: true, isBlocked: false, bio: "راهنمای تورهای فرهنگی شیراز", permissions: [], location: { city: "شیراز" } },
  { name: "حسین کریمی", phone: "09194561234", handle: "demo-hossein-karimi", role: "creator", creatorType: "tour_leader", isVerified: false, isBlocked: false, bio: "راهنمای تورهای کویری", permissions: [], location: { city: "کاشان" } },
  { name: "زهرا موسوی", phone: "09122334455", handle: "demo-zahra-mousavi", role: "creator", creatorType: "tour_leader", isVerified: true, isBlocked: false, bio: "تورلیدر یزد و بافت تاریخی", permissions: [], location: { city: "یزد" } },
...
function buildAuditLogs(superAdminId, usersById) {
  ...
  const templates = [
    ...
    { t: daysAgo(3), userId: admin2, action: "USER_ROLE_CHANGE", resource: { type: "USER", id: u4 }, changes: { before: { role: "user" }, after: { role: "creator" } }, riskLevel: "HIGH", ctx: { ip: "5.119.32.2", method: "PATCH", endpoint: "/api/admin/users/role", statusCode: 200 }, meta: {} },
